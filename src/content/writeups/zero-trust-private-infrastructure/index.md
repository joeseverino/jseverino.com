...
::figure
![Tailnet lock enabled on the VPS with a successful ping over the subnet route](/assets/writeups/zero-trust-private-infrastructure/images/tailscale-lock-subnet-route-ping.png)

Tailnet lock confirmed enabled on the VPS, with a successful ping to a homelab LAN IP over the Tailscale subnet route.
::

::figure
![VPS registered as an approved exit node in the Tailscale admin console](/assets/writeups/zero-trust-private-infrastructure/images/tailscale-admin-exit-node-approved.png)
...
::figure
![nftables firewall config on the VPS restricting SSH and container traffic](/assets/writeups/zero-trust-private-infrastructure/images/vps-nftables-firewall-config.png)
...
::figure
![Nmap scan reporting the VPS as down with no responding ports](/assets/writeups/zero-trust-private-infrastructure/images/nmap-vps-all-ports-filtered.png)
...
::figure
![Windows Firewall SSH rule scoped to the Tailscale CGNAT range](/assets/writeups/zero-trust-private-infrastructure/images/windows-firewall-ssh-tailscale-cgnat-only.png)
...
::figure
![nftables table on the Ubuntu VM limiting SSH to Tailscale and the home LAN](/assets/writeups/zero-trust-private-infrastructure/images/ubuntu-vm-nftables-ssh-restriction.png)
...
::figure
![SSH session into the offline CA virtual machine running in UTM](/assets/writeups/zero-trust-private-infrastructure/images/offline-ca-vm-ssh-session.png)
...
::figure
![AdGuard DNS rewrites mapping private subdomains to the VPS Tailscale IP](/assets/writeups/zero-trust-private-infrastructure/images/adguard-vps-subdomain-dns-rewrites.png)
...
::figure
![systemd-resolved configured to enforce Cloudflare DNS-over-TLS on the VPS](/assets/writeups/zero-trust-private-infrastructure/images/systemd-resolved-cloudflare-dot-config.png)
...
::figure
![resolvectl status confirming DNS-over-TLS is active on all interfaces](/assets/writeups/zero-trust-private-infrastructure/images/resolvectl-dns-over-tls-confirmed.png)
...
::figure
![Wireshark showing plaintext DNS queries on port 53 before DoT](/assets/writeups/zero-trust-private-infrastructure/images/wireshark-plaintext-dns-before-dot.png)
...
::figure
![Wireshark showing encrypted DNS traffic on port 853 after DoT](/assets/writeups/zero-trust-private-infrastructure/images/wireshark-dns-over-tls-after-dot.png)
...
::figure
![Uptime Kuma showing all seven monitors green from the VPS](/assets/writeups/zero-trust-private-infrastructure/images/uptime-kuma-all-monitors-green.png)
...
::figure
![Portainer managing the homelab and VPS environments from one interface](/assets/writeups/zero-trust-private-infrastructure/images/portainer-two-environments-connected.png)
