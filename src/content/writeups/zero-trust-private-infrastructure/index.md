...
::figure
![](/assets/writeups/zero-trust-private-infrastructure/images/tailscale-lock-subnet-route-ping.png)

Tailnet lock confirmed enabled on the VPS, with a successful ping to a homelab LAN IP over the Tailscale subnet route.
::

::figure
![](/assets/writeups/zero-trust-private-infrastructure/images/tailscale-admin-exit-node-approved.png)
...
::figure
![](/assets/writeups/zero-trust-private-infrastructure/images/vps-nftables-firewall-config.png)
...
::figure
![](/assets/writeups/zero-trust-private-infrastructure/images/nmap-vps-all-ports-filtered.png)
...
::figure
![](/assets/writeups/zero-trust-private-infrastructure/images/windows-firewall-ssh-tailscale-cgnat-only.png)
...
::figure
![](/assets/writeups/zero-trust-private-infrastructure/images/ubuntu-vm-nftables-ssh-restriction.png)
...
::figure
![](/assets/writeups/zero-trust-private-infrastructure/images/offline-ca-vm-ssh-session.png)
...
::figure
![](/assets/writeups/zero-trust-private-infrastructure/images/adguard-vps-subdomain-dns-rewrites.png)
...
::figure
![](/assets/writeups/zero-trust-private-infrastructure/images/systemd-resolved-cloudflare-dot-config.png)
...
::figure
![](/assets/writeups/zero-trust-private-infrastructure/images/resolvectl-dns-over-tls-confirmed.png)
...
::figure
![](/assets/writeups/zero-trust-private-infrastructure/images/wireshark-plaintext-dns-before-dot.png)
...
::figure
![](/assets/writeups/zero-trust-private-infrastructure/images/wireshark-dns-over-tls-after-dot.png)
...
::figure
![](/assets/writeups/zero-trust-private-infrastructure/images/uptime-kuma-all-monitors-green.png)
...
::figure
![](/assets/writeups/zero-trust-private-infrastructure/images/portainer-two-environments-connected.png)
